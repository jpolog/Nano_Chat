...
public class NCConnector {
	...
	public boolean registerNickname(String nick) throws IOException {
		...
		//Creamos un mensaje de tipo TextMessage con opcode OP_REGISTER_NICK en el que se inserte el nick
	...
	public boolean roomRename(String room) throws IOException {
		...
		//Analizamos el mensaje para saber si se puede renombrar la sala
	...
	public void sendPrivateMessage(String nick, String msg) throws IOException {
		//Crea el mensaje con el receptor y el texto pasado como parámetro y lo envía
