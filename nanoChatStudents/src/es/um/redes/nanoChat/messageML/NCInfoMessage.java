...
public class NCInfoMessage extends NCMessage {
	...
	/**
	 * Creamos un mensaje de tipo InfoMessage a partir del código de operación, del nombre, los miembros y el tiempo del último mensaje
	 */
	...
	//Devuelve el tiempo del último mensaje
