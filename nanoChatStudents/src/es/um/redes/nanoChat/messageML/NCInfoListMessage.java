...
public class NCInfoListMessage extends NCMessage {
	...
	/**
	 * Creamos un mensaje de tipo InfoListMessage a partir del código de operación y de la lista de salas
	 */
	...
	//Se devuelve una lista de NCRoomDescription con las descripciones de la sala
